...
{
  TILES_TB_CAVERNS_THIN_1,
  TILES_TB_CAVERNS_THIN_2,
  TILES_TB_CAVERNS_THIN_3,
  TILES_TB_CAVERNS_THIN_4,
  TILES_TB_CAVERNS_THIN_5,
  TILES_TB_CAVERNS_THIN_6,
  TILES_TB_CAVERNS_THIN_7,
  TILES_TB_CAVERNS_THIN_8,
  TILES_TB_CAVERNS_THIN_9,
  TILES_TB_CAVERNS_THIN_10,
  TILES_TB_CAVERNS_THIN_11,
  TILES_TB_CAVERNS_THIN_12,
  TILES_TB_CAVERNS_THIN_13,
  TILES_TB_CAVERNS_SLOPES_RIGHT,
  TILES_TB_CAVERNS_SLOPES_LEFT,
  TILES_TB_CAVERNS_SOLID_1,
  TILES_TB_CAVERNS_SOLID_2,
  TILES_TB_CAVERNS_SOLID_3,
  TILES_TB_CAVERNS_SOLID_4,
  TILES_TB_CAVERNS_SPAWN_1,
  TILES_TB_CAVERNS_SPAWN_2,
  TILES_TB_CAVERNS_HAZARD_1,
  TILES_TB_CAVERNS_HAZARD_2
};
